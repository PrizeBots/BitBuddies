...
function Header() {
  ...
  const maticBalance = useAppSelector((state) => state.userPathStore.maticBalance)
  const HistoryPath = useAppSelector((state) => state.userPathStore.path);
  const wbtcBalance = useAppSelector((state) => state.userPathStore.wbtcBalance)
  const metaMaskInstalled = useAppSelector((state) => state.userPathStore.metaMaskInstalled)
  ...
  console.log("selected_player_info", Object.keys(selectedPlayer).length, gameStarted)
...

{
          ...
          <ul className="dropdown-menu dropdown-menu-end" aria-labelledby="navbarDropdown">
            <li><a className="dropdown-item" href="#"> Connected Wallet </a></li>
            <li><a className="dropdown-item" href="#" key={2}> 
    ...
    >
      <nav className="navbar navbar-expand-sm navbar-dark" style={{
        ...
        <div className="container-fluid">
          <ul className="navbar-nav me-1" style={{
            gap: "10px",
            display: 'flex',
            flexDirection: 'row'
          }}>
...

                {
                  ...
                  <div style={{
                    ...
                    <li className="nav-item" key={uuidv4()} style={{ justifyContent: 'center' }} >
                      <Tooltip title="Server Latency" style={{color: 'grey'}}>
                          <NetworkCheckIcon />
                      </Tooltip>
                    </li>

                    <li className="nav-item" key={uuidv4()} style={{
                      color: 'grey', 
                      justifyContent: 'center', 
                      display: 'flex',
                      flexDirection: 'row', 
              ...
              <ul className="navbar-nav" style={{
                ...
                <li className="nav-item" key={50}>
                  <Tooltip title="Read our WhitePaper">
                    <div style={{color:"#eee"}}>
                      <a href="https://bit-fighters.gitbook.io/readme/" target="_blank">
                ...
                <li className="nav-item" key={9}>
                  <Tooltip title="Check out Instagram">
                    <div style={{color:"#E82A60"}}>
                      ...
                      <InstagramIcon color="secondary" style={{
                        color:"#EE698F"
                      }}/>
                      </a>
                    </div>
